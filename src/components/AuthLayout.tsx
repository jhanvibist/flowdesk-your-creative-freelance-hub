...
export const AuthLayout = ({ mode }: AuthLayoutProps) => {
  ...
  const onSubmit = (e: FormEvent) => {
    e.preventDefault();
    toast.success(isSignup ? "Welcome to FlowDesk!" : "Welcome back!");
    navigate("/dashboard");
  };
        ...
        <div className="flex-1 flex items-center justify-center py-10">
          <div className="w-full max-w-md animate-fade-in-up">
            ...
            <p className="text-muted-foreground mb-8">
              {isSignup
                ? "Create your FlowDesk account in seconds."
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              {isSignup && (
                <div className="space-y-2">
                  ...
                  <Input id="name" placeholder="Alex Morgan" className="rounded-xl h-11" required />
                </div>
              )}
              <div className="space-y-2">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" placeholder="you@example.com" className="rounded-xl h-11" required />
              </div>
              <div className="space-y-2">
                ...
                <Input id="password" type="password" placeholder="••••••••" className="rounded-xl h-11" required />
              </div>

              <Button type="submit" variant="wave" size="lg" className="w-full mt-2">
            ...
            <Button variant="outline" size="lg" className="w-full">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M22.5 12.27c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.75h3.57c2.08-1.92 3.28-4.74 3.28-8.07z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.75c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A10.99 10.99 0 0 0 12 23z" fill="#34A853"/><path d="M5.84 14.12A6.6 6.6 0 0 1 5.5 12c0-.74.13-1.45.34-2.12V7.04H2.18A10.99 10.99 0 0 0 1 12c0 1.78.43 3.46 1.18 4.96l3.66-2.84z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.04l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38z" fill="#EA4335"/></svg>
      ...
      <div className="hidden md:flex flex-1 relative gradient-wave overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 max-w-md p-12 text-primary-foreground animate-fade-in">
          ...
          <p className="text-primary-foreground/80 text-lg leading-relaxed">
            FlowDesk turns invoicing from a Sunday-night dread into a quiet, two-tap ritual.
          </p>
